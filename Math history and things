...
<html lang="en">
    <head>
        ...
        p {
            font-size:1.25em;
            font-family:"Helvetica", "Pacifico", monospace, "aerial", sans-serif, serif;
            color:rgb(245, 5, 245);
            background:black;
            font-style:italic;
            width:100%;
...
<h4 class="math">Subtraction is the oppisite of addition, meaning it is subtracting one number from another, resulting in an answer. <br>
...
<h4 class="math">Multiplacation is the result of repeated addition, hence why 512*2=512+512.<br>
Also, multiplying creates squares, listed in the table below.
</h4>
<a href="#begen">links</a>
<table class="math" id="squares">
    <thead>
        <tr>
            <th>number</th>
            <th>square</th>
...
<h4 class="math">Division is the oppisite of multiplacation, and therefore is repeated subtraction. Division also creates square roots, as 7225 is the square root<br>
...
<h4 class="math">Geometry is the equavilant of algebra+basic math+shapes+protractor. Geometry involves mostly using protractors to measure shapes, but it also involves bits of algebra in problems and some bits of logic and angles. Geometry also has to pytheron thereom which pretty much means the side length of the long side of the triangle is a^2+b^2=c^2, meaning a*a+b*b=c*c.</h4>
<a href="#begen">links</a>
<h3>Extra info</h3>
<table>
    <thead>
...
<br>
The oblique bar, a variant of the horizontal, was introduced by De Morgan in 1845. It was a typographic resource in printed books, in order to be able to write the fraction in a single line. The symbol that is widely used today to express division:<br>
division and multiplicationAnother one of the signs was the parenthesis, although currently it is not used much. To express 21 divided by 3, we would write 21) 3, and place the result of the division to the right after another parenthesis: 21) 3 (7.<br>
...
One of the division symbols still in use is a bar with a point above and below. It was introduced by the Swiss mathematician, Johann Heinrich Rahn, in his work Teutsche Algebra (1659). This division sign is very graphic, to the point that the bar of the fraction is a general norm.<br>
This symbol was not very successful in his home country of Switzerland or in Europe. However, it was in both Britain and the United States. In particular, it is still the symbol used on calculators for division.<br>

The German mathematician, Gottfried W. Leibniz, introduced the two points ( : ), and it is the most widely used symbol nowadays. According to Leibniz, one of the advantages of using this symbol is that the division can be maintained along the same line and maintains the relationship of division with multiplication, for which Leibniz used a point.<br>
...
Early in the 17th century, the first form of our modern exponential notation was introduced by René Descartes in his text titled La Géométrie; there, the notation is introduced in Book I.[14]<br>

Some mathematicians (such as Isaac Newton) used exponents only for powers greater than two, preferring to represent squares as repeated multiplication. Thus they would write polynomials, for example, as ax + bxx + cx3 + d.<br>

Another historical synonym, involution, is now rare[15] and should not be confused with its more common meaning.<br>

In 1748, Leonhard Euler wrote:<br>
...
<br>
Rhetorical algebra, in which equations are written in full sentences. For example, the rhetorical form of x + 1 = 2 is "The thing plus one equals two" or possibly "The thing plus 1 equals 2". Rhetorical algebra was first developed by the ancient Babylonians and remained dominant up to the 16th century.<br>
Syncopated algebra, in which some symbolism is used, but which does not contain all of the characteristics of symbolic algebra. For instance, there may be a restriction that subtraction may be used only once within one side of an equation, which is not the case with symbolic algebra. Syncopated algebraic expression first appeared in Diophantus' Arithmetica (3rd century AD), followed by Brahmagupta's Brahma Sphuta Siddhanta (7th century).<br>
...
(5) If two lines are drawn which intersect a third line in such a way that the sum of the inner angles on one side is less than two right angles, then the two lines inevitably must intersect each other on that side if extended infinitely.<br>

Euclid's fifth postulate is also known as the parallel postulate.<br>
